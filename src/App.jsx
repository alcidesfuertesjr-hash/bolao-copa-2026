    ...
    <div style={page}>
      ...
      <div style={{ ...container, position: 'relative', zIndex: 1 }}>
        ...
        {effectiveTab === 'extras' && (
          ...
          {/* tabela de todos os palpites extras */}
          <div style={card}>
            <div style={h3}>Palpites extras de todos</div>
            <div style={{ fontSize: 12, color: '#94A3B8', marginBottom: 14 }}>
              {state.extrasBloqueados ? 'Palpites bloqueados — visíveis para todos.' : 'Visíveis apenas após o bloqueio pelo administrador.'}
            </div>
            {state.extrasBloqueados ? (
              ...
              <div style={{ textAlign: 'center', padding: '20px 0', color: '#94A3B8', fontSize: 13, fontStyle: 'italic' }}>
                🔒 Os palpites de outros participantes ficarão visíveis aqui após o administrador bloquear os extras.
              </div>
            )}
          </div>
          </>
