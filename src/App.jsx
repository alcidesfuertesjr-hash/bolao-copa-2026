...
const PALPITES_CLAUDE = {
  // 18/06 — resultados confirmados
  "26_Claude": { "a": 2, "b": 1 }, // Suíça x Bósnia — saiu 4x1, acertei vencedor
  "27_Claude": { "a": 2, "b": 0 }, // Canadá x Catar — saiu 6x0, acertei vencedor
  "28_Claude": { "a": 2, "b": 1 }, // México x Coreia do Sul — saiu 1x0, acertei vencedor
  // 19/06
  "30_Claude": { "a": 3, "b": 1 }, // EUA x Austrália
  "31_Claude": { "a": 1, "b": 2 }, // Escócia x Marrocos
  "32_Claude": { "a": 4, "b": 0 }, // Brasil x Haiti
  // 20/06
  "29_Claude": { "a": 2, "b": 1 }, // Turquia x Paraguai
  "33_Claude": { "a": 2, "b": 1 }, // Holanda x Suécia
  "34_Claude": { "a": 3, "b": 1 }, // Alemanha x Costa do Marfim
  "35_Claude": { "a": 3, "b": 0 }, // Equador x Curaçao
  // 21/06
  "36_Claude": { "a": 1, "b": 2 }, // Tunísia x Japão
  "37_Claude": { "a": 3, "b": 0 }, // Espanha x Arábia Saudita
  "38_Claude": { "a": 2, "b": 0 }, // Bélgica x Irã
  "39_Claude": { "a": 2, "b": 0 }, // Uruguai x Cabo Verde
  "40_Claude": { "a": 1, "b": 1 }, // Nova Zelândia x Egito
};
