...
const PALPITES_CLAUDE = {
  // 18/06 — resultados confirmados (mantidos para histórico)
  ...
  // 19/06 — meus palpites de hoje
  "30_Claude": { "a": 3, "b": 1 }, // Estados Unidos x Austrália — EUA muito superior, Austrália venceu na estreia mas EUA vem de 4x1 no Paraguai
  "31_Claude": { "a": 1, "b": 2 }, // Escócia x Marrocos — Marrocos tecnicamente superior, Escócia cansada
  "32_Claude": { "a": 4, "b": 0 }, // Brasil x Haiti — Brasil precisa de goleada pra pressionar na liderança do grupo, Haiti é o mais fraco do grupo
};
