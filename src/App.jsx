...
function SplashScreen({ onDone }) {
      ...
      if (step >= sequencia.length) {
        ...
        setTimeout(() => {
          ...
          const iv = setInterval(() => {
            ...
            if (p >= 100) {
              clearInterval(iv);
              setTimeout(() => { setHiding(true); setTimeout(onDone, 600); }, 300);
            }
          }, 30);
        }, 1000);
        return;
  ...
  const colors = ['#FFD700','#FFFFFF','#C8102E','#002395','#00A650','#EF3340'];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        animation: ringStop ? 'none' : 'ringRotate 16s linear infinite', flexShrink:0,
      }}>
        {times.map((tm, i) => {
          const angle = (i / N) * 360;
          ...
          return (
            <div key={i} style={{
              ...
              width:'min(78px,17vw)', height:'min(78px,17vw)',
              marginTop:'calc(min(78px,17vw) / -2)', marginLeft:'calc(min(78px,17vw) / -2)',
              transform:`translate(${x}px, ${y}px)`,
            }}>
              <div style={{
                width:'100%', height:'100%', borderRadius:'50%', overflow:'hidden', position:'relative',
                border: isHL ? '3px solid #FFD700' : '3px solid rgba(255,255,255,0.2)',
                boxShadow: isFinalSlot
                  ? '0 0 0 4px #FFD700,0 0 60px rgba(255,215,0,1),0 0 100px rgba(255,215,0,0.6)'
                  : isHL ? '0 0 0 3px #FFD700,0 0 30px rgba(255,215,0,0.9)' : '0 4px 15px rgba(0,0,0,0.4)',
      ...
      <div style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',textAlign:'center',zIndex:5,pointerEvents:'none'}}>
        <div style={{
          width:'min(110px,24vw)', height:'min(110px,24vw)', borderRadius:'50%', overflow:'hidden',
          border:'4px solid #FFD700',
          boxShadow: isFinal
            ? '0 0 0 4px #FFD700,0 0 60px rgba(255,215,0,0.9),0 0 100px rgba(255,215,0,0.6)'
            : '0 0 0 3px rgba(255,215,0,0.4),0 0 40px rgba(255,215,0,0.5)',
        ...
        <div style={{
          fontSize: isFinal ? 'clamp(15px,3.5vw,24px)' : 'clamp(12px,2.5vw,19px)',
          color:'#FFD700', textShadow:'0 0 20px rgba(255,215,0,0.8)', letterSpacing:'0.06em', transition:'all 0.3s',
        }}>{t.nome}</div>
      </div>
      ...
      {showPergunta && (
        <div style={{position:'absolute',bottom:'8%',textAlign:'center',zIndex:10,animation:'perguntaIn 0.8s ease-out forwards'}}>
          ...
          <span style={{color:'#FFD700',fontSize:'clamp(18px,4vw,32px)',textShadow:'0 0 30px rgba(255,215,0,0.8)',display:'block',marginTop:5}}>⚽ CAMPEÃO? ⚽</span>
