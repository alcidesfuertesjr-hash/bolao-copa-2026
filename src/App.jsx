    ...
    try {
      ...
      if (snap.exists()) {
        ...
        const confrontosFixos = {
          ...
          103: { 'timeA': 'Perdedor Jogo 101', 'ccA': 'un', 'timeB': 'Perdedor Jogo 102', 'ccB': 'un', 'dataJogo': '2026-07-18T16:00:00', 'cidade': 'Miami' },
          104: { 'timeA': 'Vencedor Jogo 101', 'ccA': 'un', 'timeB': 'Vencedor Jogo 102', 'ccB': 'un', 'dataJogo': '2026-07-19T16:00:00', 'cidade': 'Nova York/NJ' }
        };
        if (data.jogos) {
          let corrigiu = false;
